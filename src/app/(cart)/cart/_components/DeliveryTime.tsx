      ...
      <div className="relative flex flex-col gap-y-4 md:flex-row md:flex-nowrap md:gap-x-8 xl:gap-x-10">
        <div>
          ...
          <select
            ...
            className={`border border-[#bfbfbf] rounded h-10 px-4 py-2 md:w-[155px] text-base text-[#414141] focus:border-[#70c05b] focus:outline-none ${additionalStyles} ${selectStyles}`}
          >
                ...
                >
                  <button
                    ...
                    className={`p-2 rounded justify-center items-center w-full h-10 duration-300 ${
                      ...
                      slot.free &&
                      !slot.passed
                        ? "bg-[#ff6633] text-white hover:shadow-[0_4px_12px_rgba(255,102,51,0.3)] active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.2)]"
                        : slot.free && !slot.passed
                          ? "bg-[#f3f2f1] hover:shadow-[0_2px_8px_rgba(0,0,0,0.1)] cursor-pointer"
