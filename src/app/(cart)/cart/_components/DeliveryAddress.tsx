        ...
        <div className="flex flex-col gap-y-4 md:flex-row md:w-full md:justify-between md:gap-x-8">
          <div className="md:flex-1">
            ...
            <select
              ...
              className={`border border-[#bfbfbf] rounded h-10 px-4 py-2 w-full text-[#414141] text-base focus:border-[#70c05b] focus:outline-none ${additionalStyles} ${selectStyles}`}
              required
            >
          ...
          <div className="md:flex-1">
            ...
            <input
              ...
              className={`border border-[#bfbfbf] rounded h-10 px-4 py-2 w-full text-[#414141] text-base focus:border-[#70c05b] focus:outline-none ${additionalStyles}`}
              required
            />
          </div>
        </div>
        ...
        <div className="flex flex-row gap-x-4 md:gap-x-8 xl:gap-x-10">
          <div className="flex-1">
            ...
            <input
              ...
              className={`border border-[#bfbfbf] rounded h-10 px-4 py-2 w-full text-[#414141] text-base focus:border-[#70c05b] focus:outline-none min-w-[67px] ${additionalStyles}`}
              required
            />
          </div>
