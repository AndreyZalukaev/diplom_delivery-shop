      ...
      <div className="text-[#414141] w-full">
        ...
        <div className="space-y-8 text-sm md:text-base lg:text-lg">
          <div className="space-y-4">
            ...
            <p className="leading-relaxed">
              Используя Сайт, Пользователь выражает свое полное согласие с условиями настоящей Политики. В случае несогласия с условиями Политики Пользователь должен немедленно прекратить использование Сайта.
            </p>
          </div>

          <div className="space-y-3">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#414141]">
              1. Основные понятия
            </h2>
            <div className="space-y-2 pl-4">
              ...
              <p><span className="font-semibold">Пользователь</span> — посетитель Сайта, который заполнил форму обратной связи, оставил заявку, подписался на рассылку или иным образом предоставил свои персональные данные.</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 pl-4">
              ...
              <ul className="list-disc pl-8 space-y-1">
                ...
                <li>Данные, которые автоматически передаются при посещении Сайта (IP-адрес, информация о браузере, cookie-файлы).</li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 pl-4">
              ...
              <ul className="list-disc pl-8 space-y-1">
                ...
                <li>Ограничение доступа к персональным данным неуполномоченных лиц.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="pl-4 leading-relaxed">
              Оператор имеет право вносить изменения в настоящую Политику. Новая редакция Политики вступает в силу с момента ее размещения на Сайте, если иное не предусмотрено новой редакцией Политики. Действующая редакция Политики находится на Сайте в свободном доступе.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="pl-4 space-y-2">
              ...
              <div className="mt-3 space-y-1">
                <p><span className="font-semibold">Наименование:</span> ООО «Северяночка»</p>
                <p><span className="font-semibold">Юридический адрес:</span> 163015, г. Архангельск, ул. Ленина, д. 1</p>
                <p><span className="font-semibold">ИНН/КПП:</span> 2902567890 / 523656021</p>
                <p><span className="font-semibold">Email:</span> admin@severianochka.ru</p>
                <p><span className="font-semibold">Телефон:</span> +7 (800) 777-33-33</p>
              </div>
            </div>
          </div>
