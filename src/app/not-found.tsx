...
export default function NotFound() {
  return (
    <section className="w-full mx-auto px-[max(12px,calc((100%-1208px)/2))] flex flex-col items-center justify-center min-h-[60vh] text-[#414141]">
      <h1 className="text-8xl md:text-9xl font-bold text-(--color-primary) mb-4">
        404
      </h1>
      ...
      <Link
        href="/"
        className="px-6 py-3 bg-(--color-primary) text-white rounded-lg hover:opacity-90 transition-colors duration-300 font-medium"
      >
        На главную
      </Link>
    </section>
