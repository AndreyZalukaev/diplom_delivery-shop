...
function getUserData(): { id: number | null; name: string } | null {
  try {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    maxLength={19}
                    className="w-full border border-gray-300 rounded-lg px-4 py-3 text-lg text-center tracking-wider"
                    disabled={loading}
                  />
                ...
                <button
                  ...
                  className="w-full py-3 bg-[#ff6633] text-white rounded-lg font-medium text-lg hover:bg-[#e55a2e] disabled:opacity-50 transition-colors"
                >
                  {loading ? "Проверка..." : "Активировать карту"}
                </button>

                <p className="text-xs text-gray-400 text-center">
                  Введите номер карты, полученной в магазине. Бонусы начисляются автоматически при каждой покупке.
                </p>
              </form>
            )}
          </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          <div>
            <div className="w-10 h-10 bg-[#ff6633]/10 rounded-full flex items-center justify-center mx-auto mb-2">
              <span className="text-[#ff6633] font-bold">5%</span>
            </div>
            <p className="text-xs text-gray-600">Бонусов с покупок</p>
          </div>
          <div>
            <div className="w-10 h-10 bg-[#ff6633]/10 rounded-full flex items-center justify-center mx-auto mb-2">
              <span className="text-[#ff6633] font-bold">2x</span>
            </div>
