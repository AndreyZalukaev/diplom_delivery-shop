...
const PriceComparisonAlert: React.FC<PriceComparisonAlertProps> = ({
  priceComparison,
  onClose,
}) => {
  return (
      ...
      <div className="flex justify-between items-start">
        <div className="flex-1">
          <h3 className="text-yellow-800 font-semibold mb-2 flex items-center gap-2">
            ⚠️ Внимание: цены или скидки изменились
          </h3>
        ...
        <button
          onClick={onClose}
          className="text-yellow-600 hover:text-yellow-800 text-lg font-bold ml-4 flex-shrink-0 cursor-pointer"
        >
          ×
        </button>
      </div>
