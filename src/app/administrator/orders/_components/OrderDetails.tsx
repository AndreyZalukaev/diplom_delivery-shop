...
import { getStatusText } from "@/utils/orders/getStatusText";
import { getPaymentStatusText } from "@/utils/orders/getPaymentStatusText";
...
const OrderDetails = ({ order, totalWeight = 0 }: OrderDetailsProps) => {
  ...
  return (
    <div className="text-[#414141] p-5 mt-10 space-y-6">
      <h3 className="text-lg font-bold text-[#414141] mb-4">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                ул. {order.deliveryAddress?.street}, д. {order.deliveryAddress?.house}
        ...
        <div className="space-y-3 md:col-span-2 lg:col-span-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <p className="font-medium">
                {order.gender === "male" ? "Мужской" : order.gender === "female" ? "Женский" : order.gender}
              </p>
            </div>
            <div>
              <span className="text-gray-600 text-sm">Дата рождения:</span>
              <div className="flex items-center gap-2">
                <p className={`${birthdaySoon ? "text-red-500" : ""} font-medium`}>
                  {formattedBirthday}
                </p>
                {birthdaySoon && (
