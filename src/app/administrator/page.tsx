      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-[#414141] mb-2">Заказы</h3>
            <p className="text-gray-500 text-sm">Управление заказами</p>
          </Link>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-[#414141] mb-2">Статьи</h3>
            <p className="text-gray-500 text-sm">Добавление, редактирование и удаление статей</p>
          </Link>
        </div>
      </div>
    </div>
