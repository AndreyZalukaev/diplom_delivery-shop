    ...
    <div className="grid grid-cols-4 hover:bg-gray-50 transition-colors">
      ...
      <div className="p-2 md:p-3 border-r border-gray-200 flex flex-col justify-between">
        ...
        <button
          ...
          className="bg-[#ff6633] text-white hover:shadow-[0_4px_12px_rgba(255,102,51,0.3)] active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.2)] flex items-center justify-center rounded cursor-pointer duration-300 text-[10px] md:text-sm p-1"
        >
          Удалить слот
        </button>
      </div>
