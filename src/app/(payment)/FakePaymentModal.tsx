...
const FakePaymentModal = ({
  ...
  const fillTestCard = (
    cardNumber: string,
    _result: PaymentSimulationResult
  ): void => {
        ...
        <div className="mb-4 p-3 bg-gray-50 rounded">
          ...
          {testCards.map((card, index) => (
            <button
              ...
              className="block w-full text-left p-2 hover:bg-gray-100 rounded text-sm mb-1 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
